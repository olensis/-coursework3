...
import me_sad.coursework3.Service.SockService;
...
public class FilesController {
    ...
    public ResponseEntity<Void> uploadIngredientFile(@RequestParam MultipartFile file) throws FileNotFoundException, FileMessageException {
